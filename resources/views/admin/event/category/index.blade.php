...
@section('content')
    <style>
        ...
        .premium-card #eventCategoryDataTable {
        ...
        .premium-card #eventCategoryDataTable tbody td,
        .premium-card td {
    ...
    <div class="premium-admin-panel">
        ...
        <div class="d-flex flex-wrap justify-content-between align-items-center mb-4">
            <h4 class="fs-24 fw-600 premium-header text-white" style="font-family: 'Playfair Display', serif;">
                <i class="fa-solid fa-layer-group" style="color: var(--gold, #D4AF5A); margin-right: 10px;"></i>{{$title}}
            </h4>
            <button type="button" class="premium-btn" data-bs-toggle="modal" data-bs-target="#add-modal">
                        ...
                        <tr>
                            <th scope="col">
                                <div><i class="fa-solid fa-tag"
                                        style="margin-right: 8px; color: var(--gold);"></i>{{ __('Name') }}</div>
                            </th>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content zModalTwo-content">
                <div class="modal-header">
                    <h5 class="modal-title fs-20 fw-600" style="color: #fff">{{__('Add New Category')}}</h5>
