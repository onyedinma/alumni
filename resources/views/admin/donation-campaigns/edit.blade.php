    ...
    <div class="p-30">
        <div>
            <div class="d-flex flex-wrap justify-content-between align-items-center pb-16">
                <h4 class="fs-24 fw-500 lh-34 text-black">{{$title}}: {{ $campaign->title }}</h4>
                ...
                <form action="{{ route('admin.donation-campaigns.update', $campaign->id) }}" method="POST"
                    ...
                    <div class="row">
                            ...
                            <div class="primary-form-group mt-2">
                                <div class="primary-form-group-wrap">
                                    ...
                                    <select class="primary-form-control sf-select-without-search" name="status">
                                        <option value="1" {{ $campaign->status == 1 ? 'selected' : '' }}>{{ __('Active') }}
                                        </option>
                                        <option value="0" {{ $campaign->status == 0 ? 'selected' : '' }}>{{ __('Inactive') }}
                                        </option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="primary-form-group mt-4">
                                <div class="primary-form-group-wrap">
                                    ...
                                    <input type="text" class="primary-form-control" name="beneficiary_name"
                                        value="{{ old('beneficiary_name', $campaign->beneficiary_name) }}"
                            ...
                            <div class="primary-form-group mt-4">
                                <div class="primary-form-group-wrap">
                                    ...
                                    <select class="primary-form-control sf-select-without-search" name="is_featured">
                                        <option value="0" {{ !$campaign->is_featured ? 'selected' : '' }}>{{ __('No') }}
                                        </option>
                                        <option value="1" {{ $campaign->is_featured ? 'selected' : '' }}>{{ __('Yes') }}
                                        </option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="primary-form-group mt-4">
                                <div class="primary-form-group-wrap">
                                    ...
                                    @if($campaign->image_id)
                                        <div class="mb-2">
                                            <img src="{{ getFileURL($campaign->image) }}" alt=""
                                                style="max-width: 100px; max-height: 80px; object-fit: cover; border-radius: 8px;">
                                        </div>
                                    @endif
                        ...
                        <div class="col-12 mt-4">
                            <div class="p-20 bg-f5f5f5 bd-ra-15">
                                <h6 class="fw-600 mb-3">{{ __('Campaign Statistics') }}</h6>
                                <div class="row">
                                    <div class="col-md-4">
                                        <p class="mb-1 text-muted">{{ __('Amount Raised') }}</p>
                                        <h5 class="text-success">{{ showPrice($campaign->raised_amount) }}</h5>
                                    </div>
                                    <div class="col-md-4">
                                        <p class="mb-1 text-muted">{{ __('Goal Progress') }}</p>
                                    ...
                                    <div class="col-md-4">
                                        <p class="mb-1 text-muted">{{ __('Total Donations') }}</p>
                    ...
                    <div class="mt-4">
                        ...
                        <a href="{{ route('admin.donation-campaigns.donations', $campaign->id) }}"
                            class="py-10 px-26 bg-primary-color border-0 bd-ra-12 fs-15 fw-500 lh-25 text-white ms-2">
                            {{ __('View Donations') }}
                        </a>
                    </div>
                </form>
