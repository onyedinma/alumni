...
@section('content')
    ...
    <style>
        ...
        .premium-card #noticeDataTable tbody td,
        .premium-card td {
        ...
        <div>
            ...
            <div class="d-flex flex-wrap justify-content-between align-items-center pb-16">
                <h4 class="fs-24 fw-600 premium-header text-white" style="font-family: 'Playfair Display', serif;">
                    <i class="fa-solid fa-bullhorn" style="color: var(--gold, #D4AF5A); margin-right: 10px;"></i>{{$title}}
                </h4>
                <button type="submit" class="premium-btn" data-bs-toggle="modal" data-bs-target="#add-modal"><i
                    ...
                    <table class="table zTable" id="noticeDataTable">
                        <thead>
                            <tr>
                                ...
                                <th scope="col">
                                    <div><i class="fa-solid fa-tags" style="margin-right: 8px;"></i>{{ __('Category') }}
                                    </div>
                                </th>
                                <th scope="col">
