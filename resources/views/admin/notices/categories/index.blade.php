...
@section('content')
    <style>
        ...
        .premium-card #noticeCategoryDataTable {
        ...
        .premium-card #noticeCategoryDataTable tbody td,
        .premium-card td {
    ...
    <div class="premium-admin-panel">
        ...
        <div class="d-flex flex-wrap justify-content-between align-items-center mb-4">
            <h4 class="fs-24 fw-600 premium-header text-white" style="font-family: 'Playfair Display', serif;">
                <i class="fa-solid fa-list-ul" style="color: var(--gold, #D4AF5A); margin-right: 10px;"></i>{{$title}}
            </h4>
        ...
        <div class="premium-card">
            ...
            <div class="table-responsive zTable-responsive">
                <table class="table zTable" id="noticeCategoryDataTable">
                    <thead>
                        <tr>
                            <th scope="col">
    ...
    <div class="modal fade zModalTwo" id="add-modal" aria-hidden="true" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content zModalTwo-content">
                <form class="ajax reset" action="{{ route('admin.notices.categories.store') }}" method="post"
