...
@section('content')
    <style>
        ...
        .premium-card #newsDataTable tbody td,
        .premium-card td {
        ...
        <div>
            ...
            <div class="d-flex flex-wrap justify-content-between align-items-center pb-16">
                ...
                <button type="submit" id="add-news" class="premium-btn" data-bs-toggle="modal"
                    data-bs-target="#add-modal"><i class="fa fa-plus"></i>
                    {{ __('Add New') }}</button>
            </div>
