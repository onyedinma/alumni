...
@section('content')
    <style>
        ...
        .premium-card #newsCategoryDataTable {
        ...
        .premium-card #newsCategoryDataTable tbody td,
        .premium-card td {
    ...
    <div class="premium-admin-panel">
        <div>
            ...
            <div class="d-flex flex-wrap justify-content-between align-items-center mb-4">
                ...
                <button type="submit" id="add-news" class="premium-btn" data-bs-toggle="modal"
