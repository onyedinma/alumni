...
@section('content')
    <style>
        ...
        .premium-card #passingYearDataTable {
        ...
        .premium-card #passingYearDataTable tbody td,
        .premium-card td {
