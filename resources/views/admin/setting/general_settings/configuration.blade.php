...
@section('content')
    ...
    <div class="premium-admin-panel">
                            ...
                            <div class="table-responsive zTable-responsive">
                                <table class="table zTable">
                                    <thead>
                                        <tr>
                                            <th class="min-w-160">
                                                <div><i class="fa-solid fa-puzzle-piece"
                                                        style="margin-right: 8px;"></i>{{ __('Extension') }}</div>
                                            </th>
                                            <th class="text-center">
                                                <div><i class="fa-solid fa-toggle-on"
        ...
        ? 'checked' : '' }} name="email_verification_status" type="checkbox"
                                        ...
                                        @if(!isAddonInstalled('ALUSAAS'))
                                                                        <tr>
                                                                            ...
                                                                            <td class="text-center pt-17">
                                                                                <div class="zCheck form-switch">
                                                                                    <input class="form-check-input mt-0"
                                                                                        onchange="changeSettingStatus(this,'app_mail_status')" value="1" {{ getOption('app_mail_status') == STATUS_ACTIVE
                                            ? 'checked' : '' }}
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center pt-17">
                                                <div class="zCheck form-switch">
                                                    <input class="form-check-input mt-0"
                                                        onchange="changeSettingStatus(this,'app_sms_status')" value="1" {{ getOption('app_sms_status') == STATUS_ACTIVE
        ? 'checked' : '' }}
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center pt-17">
                                                <div class="zCheck form-switch">
                                                    <input class="form-check-input mt-0"
                                                        onchange="changeSettingStatus(this,'pusher_status')" value="1" {{ getOption('pusher_status') == STATUS_ACTIVE
        ? 'checked' : '' }}
                                            ...
                                            <td class="text-center pt-17">
                                                <div class="zCheck form-switch">
                                                    <input class="form-check-input mt-0"
                                                        ...
                                                        {{ getOption('google_login_status') == STATUS_ACTIVE
        ? 'checked' : '' }} name="google_login_status" type="checkbox" role="switch"
        ...
        ? 'checked' : '' }} name="facebook_login_status" type="checkbox"
                                        ...
                                        <tr>
                                            <td>
                                                <h6>{{ __('WhatsApp Chat Widget') }}</h6>
                                                <small
                                                    class="fst-italic fw-normal">({{ __('Enable floating WhatsApp chat widget for visitor support.') }})</small>
                                            </td>
                                            <td class="text-center pt-17">
                                                <div class="zCheck form-switch">
                                                    <input class="form-check-input mt-0"
                                                        onchange="changeSettingStatus(this,'whatsapp_status')" value="1" {{
        getOption('whatsapp_status') == STATUS_ACTIVE
        ? 'checked' : '' }}
                                                        name="whatsapp_status" type="checkbox" role="switch"
                                                        id="whatsapp_status">
                                                </div>
                                            </td>
                                            <td>
                                                <div class="action__buttons d-flex justify-content-end gap-2">
                                                    <button type="button" class="btn btn-outline-success p-2"
                                                        onclick="configureModal('whatsapp_status')"
                                                        title="{{ __('Configure') }}">
                                                        <i class="fa-solid fa-wrench"></i> {{ __('Configure') }}
                                                    </button>
                                                </div>
                                        ...
                                        <tr>
                                            <td>
                                                <h6>{{ __('Birthday Auto-Post') }}</h6>
                                                <small
                                                    class="fst-italic fw-normal">({{ __('Enable automated birthday wishes on the Alumni Feed and via Email.') }})</small>
                                            </td>
                                            <td class="text-center pt-17">
                                                <div class="zCheck form-switch">
                                                    <input class="form-check-input mt-0"
                                                        onchange="changeSettingStatus(this,'birthday_auto_post_status')"
                                                        value="1" {{
        getOption('birthday_auto_post_status') == STATUS_ACTIVE
        ? 'checked' : '' }} name="birthday_auto_post_status" type="checkbox"
                                                        role="switch" id="birthday_auto_post_status">
                                                </div>
                                            </td>
                                            <td>
                                                <div class="action__buttons d-flex justify-content-end gap-2">
                                                    <button type="button" class="btn btn-outline-success p-2"
                                                        onclick="configureModal('birthday_auto_post_status')"
                                                        title="{{ __('Configure') }}">
                                                        <i class="fa-solid fa-wrench"></i> {{ __('Configure') }}
                                                    </button>
                                                </div>
                                        ...
                                        <tr>
                                            <td>
                                                <h6>{{ __('Fun Facts Section') }}</h6>
                                                <small
                                                    class="fst-italic fw-normal">({{ __('Enable the "Did You Know?" section on the homepage to display random school facts.') }})</small>
                                            </td>
                                            <td class="text-center pt-17">
                                                <div class="zCheck form-switch">
                                                    <input class="form-check-input mt-0"
                                                        onchange="changeSettingStatus(this,'fun_facts_status')" value="1" {{
        getOption('fun_facts_status') == STATUS_ACTIVE ? 'checked' : '' }}
                                                        name="fun_facts_status" type="checkbox" role="switch"
                                                        id="fun_facts_status">
                                                </div>
                                            </td>
                                            <td>
                                                <div class="action__buttons d-flex justify-content-end gap-2">
                                                    <button type="button" class="btn btn-outline-success p-2"
                                                        onclick="configureModal('fun_facts_status')"
                                                        title="{{ __('Configure') }}">
                                                        <i class="fa-solid fa-wrench"></i> {{ __('Configure') }}
                                                    </button>
                                                </div>
        ...
        ? 'checked' : '' }} name="google_recaptcha_status" type="checkbox"
        ...
        ? 'checked' : '' }} name="google_analytics_status" type="checkbox"
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center pt-17">
                                                <div class="zCheck form-switch">
                                                    <input class="form-check-input mt-0"
                                                        onchange="changeSettingStatus(this,'cookie_status')" value="1" {{ getOption('cookie_status') == STATUS_ACTIVE
        ? 'checked' : '' }}
        ...
        ? 'checked' : '' }} name="register_file_required" type="checkbox"
        ...
        ? 'checked' : '' }} name="registration_approval" type="checkbox"
                                        ...
                                        @if(!isAddonInstalled('ALUSAAS'))
                                            ...
                                            ? 'checked' : '' }} name="show_language_switcher" type="checkbox"
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td class="text-center pt-17">
                                                                                <div class="zCheck form-switch">
                                                                                    <input class="form-check-input mt-0"
                                                                                        onchange="changeSettingStatus(this,'app_debug')" value="1" {{ getOption('app_debug') == STATUS_ACTIVE ? 'checked' : '' }}
