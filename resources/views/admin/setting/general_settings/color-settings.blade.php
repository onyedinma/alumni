                                    ...
                                    <div class="col-md-4">
                                        <div class="primary-form-group">
                                            <div class="primary-form-group-wrap zImage-upload-details">
                                                ...
                                                <label for="zImageUploadPreloader"
                                    ...
                                    <div class="col-md-4">
                                        <div class="primary-form-group">
                                            <div class="primary-form-group-wrap zImage-upload-details">
                                                ...
                                                <label for="zImageUploadBlackLogo"
                                        ...
                                        <div class="primary-form-group">
                                            <div class="primary-form-group-wrap zImage-upload-details">
                                                ...
                                                <label for="zImageUploadLogo"
                                                    class="form-label">{{__('Logo White')}}</label>
                                                <div class="upload-img-box">
                                                    ...
                                                    @else
                                                        <img src="" />
                                                    @endif
                                                    <input type="file" name="app_logo" id="zImageUploadLogo"
                                                        accept="image/*,video/*" onchange="previewFile(this)" />
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="primary-form-group">
                                            <div class="primary-form-group-wrap zImage-upload-details">
                                                ...
                                                <label for="zImageUploadLoginImage" class="form-label">{{__('Login Left
                                                    Image')}}</label>
                                                <div class="upload-img-box">
