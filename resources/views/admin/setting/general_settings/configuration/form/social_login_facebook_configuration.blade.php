<div class="">
    <div class="d-flex flex-wrap justify-content-between align-items-center mb-4">
        <h4 class="fs-18 fw-600 mb-0 text-white">{{ __('Social Login (Facebook) Configuration') }}</h4>
    ...
    <form class="ajax" action="{{route('admin.setting.common.settings.update')}}" method="POST"
        ...
        <div class="row mb-3">
            <div class="col-lg-12">
                <div class="primary-form-group">
                    <label class="form-label text-white">{{ __('Facebook Client ID') }}</label>
        ...
        <div class="row mb-3">
            <div class="col-lg-12">
                <div class="primary-form-group">
                    <label class="form-label text-white">{{ __('Facebook Client Secret') }} </label>
        ...
        <div class="row mb-3">
            <div class="col-lg-12">
                <label class="text-white">{{ __('Set callback URL') }} : <strong
                        style="color: var(--gold, #D4AF5A);">{{ url('/auth/facebook/callback') }}</strong></label>
            </div>
        </div>
        <div class="row mt-3">
