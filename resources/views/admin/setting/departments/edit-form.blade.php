            ...
            <div class="col-12  mb-25">
                <div class="primary-form-group mt-2">
                    <div class="primary-form-group-wrap">
                        ...
                        <input type="text" class="primary-form-control" value="{{ $department->name ?? '' }}" name="name"
                            required placeholder="{{ __('Type Department Name') }}">
                    </div>
                </div>
            </div>
            <div class="col-12  mb-25">
                <div class="primary-form-group mt-2">
                    <div class="primary-form-group-wrap">
                        <label for="short_name" class="form-label">{{ __('Short Name') }} <span
                                class="text-danger">*</span></label>
                        <input type="text" class="primary-form-control" value="{{ $department->short_name ?? '' }}"
