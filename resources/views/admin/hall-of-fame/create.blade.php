...
@section('content')
    <div class="p-30">
        ...
        <div class="form-card">
            ...
            <div class="form-body">
                <form action="{{ route('admin.hall-of-fame.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="year_inducted" class="form-control" required
                                value="{{ old('year_inducted', date('Y')) }}" min="1900" max="{{ date('Y') }}">
                        </div>
                        ...
                        <div class="form-group full-width">
                            ...
                            <textarea name="achievement_description" class="form-control"
                                placeholder="{{ __('Describe the achievements that warranted this recognition...') }}">{{ old('achievement_description') }}</textarea>
                        </div>
                    ...
                    <div class="form-actions">
                        <button type="submit" class="btn-save">
                            <i class="bi bi-check-lg"></i> {{ __('Save Inductee') }}
                        </button>
