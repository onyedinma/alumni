...
@section('content')
    <style>
        ...
        .premium-card #transactionDataTable {
        ...
        .premium-card #transactionDataTable tbody td,
        .premium-card td {
