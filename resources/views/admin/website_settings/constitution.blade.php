                        ...
                        <div class="email-inbox__area bg-style form-horizontal__item bg-style admin-general-settings-page">
                            ...
                            <form class="ajax" action="{{ route('admin.setting.application-settings.update') }}"
                                ...
                                <div class="col-lg-6">
                                    <div class="primary-form-group my-2 pt-3">
                                        <div class="primary-form-group-wrap">
                                            ...
                                            <div class="">
                                                <textarea name="constitution_title"
                                                    class="primary-form-control">{{ getOption('constitution_title') }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="primary-form-group my-2 pt-3">
                                        <div class="primary-form-group-wrap">
                                            <label class="form-label">{{ __('Constitution Content') }} <span
                                                    class="text-danger">*</span></label>
                                            <div class="">
                                                <textarea name="constitution_description"
                                                    class="primary-form-control summernoteOne">{{ getOption('constitution_description') }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
