    ...
    <div class="premium-admin-panel">
        <div class="">
            <h4 class="fs-24 fw-600 premium-header text-white pb-16" style="font-family: 'Playfair Display', serif;">
                <i class="fa-solid fa-flag" style="color: var(--gold); margin-right: 10px;"></i>{{ __('Website Setting') }}
            </h4>
            <div class="row">
                        ...
                        <form class="ajax" action="{{ route('admin.setting.application-settings.update') }}" method="POST"
                            ...
                            <div class="row">
                                <div class="col-12 mb-4">
                                    <div class="primary-form-group my-2">
                                        <div class="primary-form-group-wrap">
                                            <label class="form-label">{{ __('Banner Title') }} <span
                                                    class="text-danger">*</span></label>
                                            <div class="premium-input-group">
                                                <span class="premium-input-group-text"><i
                                                        class="fa-solid fa-heading"></i></span>
                                                <textarea name="banner_title" class="primary-form-control"
                                                    rows="2">{{ getOption('banner_title') }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 mb-4">
                                    <div class="primary-form-group my-2">
                                        <div class="primary-form-group-wrap">
                                            <label class="form-label">{{ __('Banner Description') }} <span
                                                    class="text-danger">*</span></label>
                                            <div class="premium-input-group">
                                                <span class="premium-input-group-text"><i
                                                        class="fa-solid fa-align-left"></i></span>
                                                <textarea name="banner_description" class="primary-form-control"
                                                    rows="4">{{ getOption('banner_description') }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 mb-4">
                                    <label class="form-label">{{ __('Banner Breadcrumb Background') }} <span
                                            class="text-danger">*</span></label>
                                    <div class="premium-upload-box">
                                        ...
                                        <input type="file" name="banner_background_breadcrumb" accept="image/*"
                                            onchange="previewFile(this)">

                                        <div class="mt-3">
                                            @if (getOption('banner_background_breadcrumb'))
                                                <img src="{{ getSettingImage('banner_background_breadcrumb') }}"
                                ...
                                <div class="col-12 mt-4 text-end">
                                    <button type="submit" class="premium-btn">{{ __('Update Banner Settings') }}</button>
                                </div>
                            </div>
                        </form>
                    </div>
