    ...
    <div class="premium-admin-panel">
        <div class="">
            <h4 class="fs-24 fw-600 premium-header text-white pb-16" style="font-family: 'Playfair Display', serif;">
                <i class="fa-solid fa-file-contract" style="color: var(--gold); margin-right: 10px;"></i>{{ __($title) }}
            </h4>
            <div class="row">
                                    ...
                                    <div class="primary-form-group my-2">
                                        <div class="primary-form-group-wrap">
                                            ...
                                            <div class="premium-input-group">
                                                ...
                                                <input type="text" name="terms_condition_title" class="primary-form-control"
                                                    value="{{ getOption('terms_condition_title') }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="primary-form-group my-2">
                                        <div class="primary-form-group-wrap">
                                            <label class="form-label">{{ __('Content') }} <span
                                                    class="text-danger">*</span></label>
                                            <textarea name="terms_condition_description"
                                                class="premium-form-control summernoteOne">{{ getOption('terms_condition_description') }}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
