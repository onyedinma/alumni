                        ...
                        <form class="ajax" action="{{ route('admin.setting.application-settings.update') }}" method="POST"
                            ...
                            <div class="row">
                                <div class="col-12 mb-4">
                                    <div class="primary-form-group my-2">
                                        <div class="primary-form-group-wrap">
                                            <label class="form-label">{{ __('About Us Title') }} <span
                                                    class="text-danger">*</span></label>
                                            <div class="premium-input-group">
                                                <span class="premium-input-group-text"><i
                                                        class="fa-solid fa-heading"></i></span>
                                                <textarea name="about_us_title" class="primary-form-control"
                                                    rows="2">{{ getOption('about_us_title') }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 mb-4">
                                    <div class="primary-form-group my-2">
                                        <div class="primary-form-group-wrap">
                                            <label class="form-label">{{ __('About Us Description') }} <span
                                                    class="text-danger">*</span></label>
                                            <textarea name="about_us_description"
                                                class="premium-form-control summernoteOne">{{ getOption('about_us_description') }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 mb-4">
                                    <label class="form-label">{{__('About Us Breadcrumb Background')}} <span
                                            class="text-danger">*</span></label>
                                    <div class="premium-upload-box">
                                        <div class="upload-icon"><i class="fa-solid fa-cloud-arrow-up"></i></div>
                                        <div class="upload-text">{{__('Drag & drop image here or click to browse')}}</div>
                                        <p class="small text-muted mb-0">(jpg, jpeg, png)</p>
                                        <input type="file" name="about_us_background_breadcrumb" accept="image/*"
                                            onchange="previewFile(this)">

                                        <div class="mt-3">
                                            @if(getOption('about_us_background_breadcrumb'))
                                                <img src="{{ getSettingImage('about_us_background_breadcrumb') }}"
                                ...
                                <div class="col-12 mt-4 text-end">
                                    <button type="submit" class="premium-btn">{{ __('Update About Us') }}</button>
                                </div>
                            </div>
                        </form>
                    </div>
