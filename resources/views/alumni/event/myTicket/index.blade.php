...
@section('content')
  <style>
    ...
    .premium-card #myTicketDataTable {
    ...
    .premium-card #myTicketDataTable tbody td,
    .premium-card td {
    ...
    <div class="container">
      ...
      <div class="d-flex flex-wrap justify-content-between align-items-center mb-4">
        <h4 class="fs-24 fw-600 premium-header text-white" style="font-family: 'Playfair Display', serif;">
          <i class="fa-solid fa-ticket" style="color: var(--gold, #D4AF5A); margin-right: 10px;"></i>{{$title}}
        </h4>
      </div>
        ...
        <div class="table-responsive zTable-responsive">
          <table class="table zTable" id="myTicketDataTable">
            <thead>
              <tr>
                <th scope="col">
                  <div><i class="fa-solid fa-calendar" style="margin-right: 8px;"></i>{{ __('Event Title') }}</div>
                </th>
                <th scope="col" class="min-w-100">
                  <div><i class="fa-solid fa-barcode" style="margin-right: 8px;"></i>{{ __('Ticket Id') }}</div>
                </th>
                <th scope="col">
