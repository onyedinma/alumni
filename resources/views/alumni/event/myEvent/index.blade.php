...
@section('content')
  <style>
    ...
    .premium-card #myEventDataTable tbody td,
    .premium-card td {
    ...
    <div class="container">
      ...
      <div class="d-flex flex-wrap justify-content-between align-items-center mb-4">
        <h4 class="fs-24 fw-600 premium-header text-white" style="font-family: 'Playfair Display', serif;">
          <i class="fa-solid fa-calendar-check" style="color: var(--gold, #D4AF5A); margin-right: 10px;"></i>{{$title}}
        </h4>
      </div>
