...
@section('content')
    <style>
        ...
        .btn-premium-gold {
            ...
            color: #000000;
            /* Black text on gold for classic contrast */
            border: none;
            padding: 16px 40px;
            border-radius: 12px;
            font-weight: 600;
        ...
        /* Fix Summernote editor text visibility */
        ...
        .summernoteOne~.note-editor .note-editing-area .note-editable {
        ...
        .summernoteOne~.note-editor .note-toolbar .note-btn:hover {
                ...
                <div class="col-lg-10">
                    ...
                    <div class="premium-event-card">
                        ...
                        <form class="ajax reset" data-handler="commonResponseRedirect"
                            data-redirect-url="{{route('event.my-event')}}" action="{{ route('event.store') }}"
                            ...
                            <div class="premium-form-grid">
                                ...
                                <div class="full-width">
                                    ...
                                    <input type="text" class="premium-input" id="eventTitle" name="title"
                                        placeholder="{{ __('Annual Alumni Meetup 2024') }}">
                                </div>
                                ...
                                <div>
                                    ...
                                    <select class="premium-select sf-select-without-search" name="event_category_id"
                                ...
                                <div>
                                    ...
                                    <input type="number" name="number_of_ticket" class="premium-input" id="eventTicket"
                                        placeholder="Ex: 300">
                                </div>
                                ...
                                <div class="d-none" id="eventPrice">
                                    ...
                                    <input type="number" name="price" step="0.01" class="premium-input" id="price"
                                        placeholder="$0.00">
                                </div>
                                ...
                                <div class="full-width">
                                    ...
                                    <input name="location" class="premium-input" id="eventLocation"
                                        placeholder="{{ __('e.g. Grand Hall, City Center') }}" />
                                </div>
                                ...
                                <div class="full-width">
                                    ...
                                    <textarea name="description" class="premium-textarea min-h-180 summernoteOne"
                                        id="eventDescription" rows="5"
                                        placeholder="{{ __('Write a compelling description for your event...') }}"></textarea>
                                </div>
                                ...
                                <div>
                                    <label class="premium-label">
                                        ...
                                        {{__('Event Thumbnail')}} <span class="text-required">*</span> <small
                                            class="text-muted">(jpg, png)</small>
                                    </label>
                                ...
                                <div>
                                    <label class="premium-label">
                                        <i class="fa-solid fa-ticket label-icon"></i>
                                        {{__('Ticket Design')}} <span class="text-required">*</span> <small
                                            class="text-muted">(jpg, png)</small>
                                    </label>
                                    <div class="premium-upload-box">
                                        <img src="" class="preview-image">
