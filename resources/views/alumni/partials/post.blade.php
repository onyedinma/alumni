        ...
        <div class="like-comment-area like-comment-area-{{ $post->slug }}">
            ...
            <div class="py-17 border-b border-white/10">
                <ul class="d-flex flex-wrap align-items-center cg-40 rg-10">
                    ...
                    <li>
                        <button class="d-flex align-items-center cg-7 border-0 p-0 bg-transparent post-comment-button"
                            type="button" data-bs-toggle="collapse" data-bs-target="#collapseExample-{{ $post->id }}"
            ...
            <div class="mt-17 comment-input-box">
                ...
                <div class="d-flex align-items-center cg-15 pb-5 pl-40 d-none reply-note">
                    ...
                    <p class="fs-12 fw-400 lh-20 text-707070 divider-one">{{ __('Replying to') }} <a
                            class="fw-600 text-1b1c17 reply-to-name"></a></p>
                    <button
                        class="border-0 p-0 bg-transparent fs-12 fw-400 lh-20 text-707070 cancel-reply-to">{{ __('Cancel') }}</button>
                </div>
                <!--  -->
