                        ...
                        <ul class="messagePhoto postPhotoItems {{ $photoGalleryClass }} gallery pb-6">
                            @foreach ($chat->media as $index => $media)
                                @if(in_array($media->file_manager->extension ?? '', ['png', 'jpg', 'svg', 'jpeg', 'gif']))
                                    <li>
                                        <a
                                            href="{{ asset(getFile($media->file_manager->path ?? '', $media->file_manager->storage_type)) }}"><img
                                ...
                                <div class="file pb-6">
                                    <div class="d-flex align-items-center cg-16">
                                        ...
                                        <div class="">
                                            ...
                                            <span
                                                class="fs-13 fw-400 lh-16 text-1b1c17">{{ humanFileSize($media->file_manager->size, 'MB') }}</span>
                                        </div>
                                    </div>
                                </div>
                            @endif
