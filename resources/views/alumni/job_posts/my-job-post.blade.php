...
@section('content')
  <style>
    ...
    .premium-job-card #jobPostDataTable {
    ...
    .premium-job-card #jobPostDataTable thead {
    ...
    .premium-job-card #jobPostDataTable thead th,
    ...
    .premium-job-card #jobPostDataTable tbody td,
    .premium-job-card td {
  ...
  <div class="premium-job-list">
    <div class="container">
      <input type="hidden" id="job-post-list-route" value="{{ route('jobPost.my-job-post') }}">
      ...
      <div class="premium-job-card">
        ...
        <div class="table-responsive zTable-responsive">
          <table class="table zTable" id="jobPostDataTable">
            <thead>
              <tr>
                <th scope="col">
                ...
                <th scope="col">
                  <div><i class="fa-solid fa-circle-check" style="margin-right: 8px;"></i>{{ __('Status') }}</div>
                </th>
