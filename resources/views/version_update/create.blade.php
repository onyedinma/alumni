            ...
            <div class="bg-white bd-half bd-c-ebedf0 bd-ra-25 p-30">
                <div class="row">
                    <div class="billing-center-area bg-off-white theme-border radius-4">
                                            ...
                                            <td>
                                                ...
                                                @else
                                                    {{ getOption('current_version') }} <i data-bs-toggle="tooltip"
                                                        data-bs-placement="top" title="Update available"
                        ...
                        @if (getCustomerCurrentBuildVersion() < $latestBuildVersion)
                            <div class="col-md-8 mt-30 offset-md-2">
                                        ...
                                        <tbody class="align-baseline">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td width="251px">
                                                                                <div id="actions">
                                                                                    ...
                                                                                    <a data-url="{{ route((isAddonInstalled('ALUSAAS') ? 'super_admin' : 'admin') . '.version-update-execute') }}"
                                            ...
                                            @if ($uploadedFile != '')
                                                <tr>
                                                    <td>
                                                        {{ $uploadedFile }}
                                                        <a data-url="{{ route((isAddonInstalled('ALUSAAS') ? 'super_admin' : 'admin') . '.version-delete') }}"
                                                            data-reload="true" class="btn btn-outline-danger p-1 rounded-3 delete">
                        ...
                        @endif
                            <div
                                class="{{ count($addons) > 0 ? '' : 'd-none' }} billing-center-area bg-off-white theme-border radius-4 mt-5">
                                <div class="tenants-top-bar border-bottom pb-25">
                                    <div class="row align-items-center">
                                        <div class="col-xl-12 col-xxl-6 tenants-top-bar-left">
                                            <h4>{{ __('fgco07alumni Official Addons') }}</h4>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                        ...
                                        <div class="col-sm-12 border rounded p-3 mt-5">
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col-xs-2 col-lg-6 text-end pt-2">
                                                    <a href="{{ route((isAddonInstalled('ALUSAAS') ? 'super_admin' : 'admin') . '.addon.details', $addon->code) }}"
    ...
    @push('script')
        ...
        <script>
            ...
            var myDropzone = new Dropzone(document.body, { // Make the whole body a dropzone
                url: "{{ route((isAddonInstalled('ALUSAAS') ? 'super_admin' : 'admin') . '.version-update-store') }}", // Set the url
                method: 'post',
                headers: {
