    ...
    <div class="zSidebar-fixed">
        <ul class="zSidebar-menu" id="sidebarMenu">
            ...
            @if(isAddonInstalled('ALUSAAS'))
                <li>
                    <a href="{{route('saas.super_admin.subscriptions.orders')}}"
                        ...
                        <div class="d-flex  {{ isset($activeSubscriptionIndex) ? 'active' : 'collapsed' }}">
                            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="24" viewBox="0 0 25 24" fill="none">
                                <rect x="3.31836" y="6.00012" width="18" height="12" rx="2" stroke="white"
                                    stroke-opacity="0.7" stroke-width="1.5" />
                                <path d="M5.31836 9.00012H8.31836" stroke="white" stroke-opacity="0.7" stroke-width="1.5"
                                    stroke-linecap="round" />
                                <path d="M16.3184 15.0001H19.3184" stroke="white" stroke-opacity="0.7" stroke-width="1.5"
                                    stroke-linecap="round" />
                                <circle cx="12.3184" cy="12.0001" r="2" stroke="white" stroke-opacity="0.7"
                                    stroke-width="1.5" />
                            </svg>
                        </div>
                    ...
                    <a href="{{ route('saas.super_admin.customer_list') }}"
                        ...
                        <div class="d-flex {{ isset($showCustomerList) ? 'active' : 'collapsed' }}">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <circle cx="12" cy="6" r="4" stroke="white" stroke-opacity="0.7" stroke-width="1.5" />
                                ...
                                <path d="M6 9C4.34315 9 3 7.88071 3 6.5C3 5.11929 4.34315 4 6 4" stroke="white"
                                    stroke-opacity="0.7" stroke-width="1.5" stroke-linecap="round" />
                                <ellipse cx="12" cy="17" rx="6" ry="4" stroke="white" stroke-opacity="0.7"
                                    stroke-width="1.5" />
                ...
                <li>
                    <a href="{{route('saas.super_admin.packages.user')}}"
                ...
                <li>
                    <a href="{{route('saas.super_admin.packages.index')}}"
                        class="d-flex align-items-center cg-10 {{$activeSubscription ?? ''}}">
                ...
                <a href="{{ route('super_admin.setting.application-settings') }}"
                    ...
                    <div class="d-flex {{ isset($activeApplicationSetting) ? 'active' : 'collapsed' }}">
                        <svg width="20" height="22" viewBox="0 0 20 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <circle cx="10.1752" cy="10.889" r="2.63616" stroke="white" stroke-opacity="0.7"
                ...
                <a href="{{ route('super_admin.setting.configuration-settings') }}"
                    ...
                    <div class="d-flex {{ isset($activeConfigurationSetting) ? 'active' : 'collapsed' }}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="21" height="21" viewBox="0 0 21 21" fill="none">
                            <path d="M8.25 1.5H0.75V9H8.25V1.5Z" stroke="white" stroke-opacity="0.7" stroke-width="1.5"
                                stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M19.875 20.25H12.375" stroke="white" stroke-opacity="0.7" stroke-width="1.5"
                                stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M12.375 12.75H19.875" stroke="white" stroke-opacity="0.7" stroke-width="1.5"
                                stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M12.375 16.5H19.875" stroke="white" stroke-opacity="0.7" stroke-width="1.5"
                                stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M20.25 9H12L16.125 0.75L20.25 9Z" stroke="white" stroke-opacity="0.7"
                                stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                            <path
                                d="M4.5 20.25C6.57107 20.25 8.25 18.5711 8.25 16.5C8.25 14.4289 6.57107 12.75 4.5 12.75C2.42893 12.75 0.75 14.4289 0.75 16.5C0.75 18.5711 2.42893 20.25 4.5 20.25Z"
                                stroke="white" stroke-opacity="0.7" stroke-width="1.5" stroke-linecap="round"
                                stroke-linejoin="round" />
                        </svg>
                    </div>
            ...
            @if(isAddonInstalled('ALUSAAS'))
                <li>
                    <a href="{{route('saas.super_admin.contact-list')}}"
