...
<section>
    <div class="continer">
        <div class="join-community" data-background="{{ asset('frontend/images/community-bg.png') }}">
                        ...
                        <div class="pl-xl-75">
                            ...
                            <ul class="footer-nav">
                                ...
                                <li><a href="{{ route('donation.index') }}"
                                        class="fs-18 fw-500 lh-28 text-white-80 hover-color-white">{{ __('Donate') }}</a>
                                </li>
                                ...
                                <li><a href="{{ route('pages', 'constitution') }}"
                                        class="fs-18 fw-500 lh-28 text-white-80 hover-color-white">{{ __('Constitution') }}</a>
                                </li>
                            </ul>
                        </div>
                    </div>
