                    ...
                    <div class="col-lg-10">
                        ...
                        <div class="text-center pb-37 max-w-677 m-auto">
                            ...
                            <p class="fs-18 fw-400 lh-28 text-white">
                                {{ __('Connect with fellow FGC Ohafia 2007 graduates, attend reunions, and stay updated with our thriving alumni community activities.') }}
                            </p>
                        </div>
                        <!--  -->
                                                    ...
                                                    <div class="up-event-content">
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="d-flex"><img
                                                                    src="{{ asset('frontend/images/icon/location.svg') }}"
                                                                    alt=""></div>
                                                            <p class="fs-18 fw-500 lh-28 text-para-color">
                            ...
                            <li class="hover-scale-img">
                                ...
                                <div class="content">
                                    <div class="d-flex align-items-center cg-11 pb-10">
                                        <div class="d-flex"><img src="{{ asset('frontend/images/icon/calendar-1.svg') }}"
                                                alt=""></div>
