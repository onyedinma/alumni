    ...
    <div class="container">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6">
              <div class="bd-ra-25 bg-event-bg">
                ...
                <div class="pt-21 pb-23 px-10 text-center">
                  ...
                  <p class="fs-18 fw-400 lh-28 text-para-color">{{ $alumni->final_class_name ?? 'N/A' }},
      ...
      <div class="d-flex justify-content-center">
        <a href="{{route('alumni.list-search-with-filter')}}"
          class="border-0 bd-ra-12 py-15 px-32 bg-primary-color d-flex align-items-center cg-16 fs-18 fw-600 lh-28 text-black-color">
          {{__('View All Alumni')}}
