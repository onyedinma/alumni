                    ...
                    <div class="contact-info">
                        ...
                        <div class="contact-social">
                            ...
                            <div class="contact-social-links">
                                @if(getOption('social_facebook'))
                                    <a href="{{ getOption('social_facebook') }}" target="_blank"><i
                                            class="fab fa-facebook-f"></i></a>
                                @endif
                                @if(getOption('social_twitter'))
                                    <a href="{{ getOption('social_twitter') }}" target="_blank"><i
                                            class="fab fa-twitter"></i></a>
                                @endif
                                @if(getOption('social_instagram'))
                                    <a href="{{ getOption('social_instagram') }}" target="_blank"><i
                                            class="fab fa-instagram"></i></a>
                                @endif
                                @if(getOption('social_linkedin'))
                                    <a href="{{ getOption('social_linkedin') }}" target="_blank"><i
                                            class="fab fa-linkedin-in"></i></a>
                                @endif
                                @if(!getOption('social_facebook') && !getOption('social_twitter') && !getOption('social_instagram') && !getOption('social_linkedin'))
                    ...
                    <div class="contact-form-wrap">
                        ...
                        <form action="{{ route('contact_us.store') }}" method="post" data-handler="settingCommonHandler">
                            ...
                            <div class="contact-form-group">
                                <label for="csName">Your Name</label>
