        ...
        <ul class="zSidebar-menu" id="sidebarMenu">
            ...
            @if(!isCentralDomain() || !isAddonInstalled('ALUSAAS'))
                ...
                <li>
                    ...
                    <div class="collapse {{ $showStoryManagement ?? '' }}" id="storyMenu" data-bs-parent="#sidebarMenu">
                        <ul class="zSidebar-submenu">
                ...
                @if (auth()->user()->role == USER_ROLE_ADMIN)
                    <li>
                        <a href="{{ route('admin.donation-campaigns.index') }}"
                            class="{{ $activeDonationCampaign ?? '' }} d-flex align-items-center cg-10">
                            <div class="d-flex">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path
                                        d="M12 21C12 21 3 13.5 3 8.5C3 5.46243 5.46243 3 8.5 3C10.2 3 11.7 3.8 12.5 5C13.3 3.8 14.8 3 16.5 3C19.5376 3 22 5.46243 22 8.5C22 13.5 12 21 12 21Z"
                                        stroke="white" stroke-opacity="0.7" stroke-width="1.5" stroke-linecap="round"
                                        stroke-linejoin="round" />
                                    <path d="M12 11V17M9 14H15" stroke="white" stroke-opacity="0.7" stroke-width="1.5"
                                        stroke-linecap="round" />
                                </svg>
                            </div>
                            <span class="">{{ __('Donation Campaigns') }}</span>
                        </a>
                    </li>
                @endif
                <li>
                        ...
                        <div class="d-flex">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
                                    ...
                                    stroke="white" stroke-opacity="0.7" stroke-width="1.5" stroke-linecap="round"
                                    stroke-linejoin="round" />
                                <path d="M4.63477 13.5656L0.856444 20.1099L4.93902 19.016L6.03294 23.0985L9.3112 17.4204"
                                    stroke="white" stroke-opacity="0.7" stroke-width="1.5" stroke-linecap="round"
                                    stroke-linejoin="round" />
                                ...
                                <path
                                    ...
                                    stroke="white" stroke-opacity="0.7" stroke-width="1.5" stroke-linecap="round" />
                                <circle cx="11.9972" cy="6" r="2.57143" stroke="white" stroke-opacity="0.7"
                                    stroke-width="1.5" stroke-linecap="round" />
                            </svg>
                        </div>
                        ...
                        <div class="d-flex">
                            <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
                                    ...
                                    stroke="white" stroke-opacity="0.7" stroke-width="1.5" stroke-linecap="round"
                                    stroke-linejoin="round" />
                                <path d="M9.375 9.375L15.625 9.375" stroke="white" stroke-opacity="0.7" stroke-width="1.5"
                ...
                <a href="{{ route('transaction.list') }}"
                    ...
                    <div class="d-flex">
                        <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path d="M5.31836 9.94522H8.31836" stroke="white" stroke-opacity="0.7" stroke-width="1.5"
                                stroke-linecap="round"></path>
                            <path d="M16.3184 15.9452H19.3184" stroke="white" stroke-opacity="0.7" stroke-width="1.5"
                                stroke-linecap="round"></path>
                    ...
                    <div class="d-flex">
                        <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                                ...
                                stroke="white" stroke-opacity="0.7" stroke-width="1.5" stroke-linecap="round" />
                            <circle cx="12" cy="8.94522" r="4" stroke="white" stroke-opacity="0.7" stroke-width="1.5"
                                stroke-linecap="round" />
                        </svg>
                    </div>
            ...
            <li>
                <a href="{{ route('settings') }}" class="{{ $activeSettings ?? '' }} d-flex align-items-center cg-10">
                    <div class="d-flex">
            ...
            @if (auth()->user()->role == USER_ROLE_ADMIN)
                @if(!isCentralDomain() || !isAddonInstalled('ALUSAAS'))
                    ...
                    <li>
                        ...
                        <div class="collapse {{ $showAdminAlumni ?? '' }}" id="alumni-admin" data-bs-parent="#sidebarMenu">
                            <ul class="zSidebar-submenu">
                    ...
                    <li>
                        ...
                        <div class="collapse {{ $showMembership ?? '' }}" id="membership-admin" data-bs-parent="#sidebarMenu">
                            <ul class="zSidebar-submenu">
                                <li>
                    ...
                    <li>
                        <a href="#manage-notice-menu" data-bs-toggle="collapse" role="button"
                            aria-expanded="{{ isset($showManageNotice) ? 'true' : 'false' }}" aria-controls="manage-notice-menu"
                            class="d-flex align-items-center cg-10 {{ isset($showManageNotice) ? 'active' : 'collapsed' }}">
                            <div class="d-flex">
                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <circle cx="10" cy="10" r="9.25" stroke="white" stroke-opacity="0.7" stroke-width="1.5" />
                                    <path
                    ...
                    <li>
                        <a href="#manage-news-menu" data-bs-toggle="collapse" role="button"
                            aria-expanded="{{ isset($showManageNews) ? 'true' : 'false' }}" aria-controls="manage-news-menu"
                        ...
                        <div class="collapse {{ $showManageNews ?? '' }}" id="manage-news-menu" data-bs-parent="#sidebarMenu">
                            <ul class="zSidebar-submenu">
