...
Route::group(['prefix' => 'donation-campaigns', 'as' => 'donation-campaigns.'], function () {
    ...
    Route::get('create', [\App\Http\Controllers\Admin\DonationCampaignController::class, 'create'])->name('create');
    Route::post('store', [\App\Http\Controllers\Admin\DonationCampaignController::class, 'store'])->name('store');
    Route::get('edit/{id}', [\App\Http\Controllers\Admin\DonationCampaignController::class, 'edit'])->name('edit');
    Route::post('update/{id}', [\App\Http\Controllers\Admin\DonationCampaignController::class, 'update'])->name('update');
    Route::post('delete/{id}', [\App\Http\Controllers\Admin\DonationCampaignController::class, 'destroy'])->name('delete');
    Route::post('toggle-status/{id}', [\App\Http\Controllers\Admin\DonationCampaignController::class, 'toggleStatus'])->name('toggle-status');
    Route::get('{id}/donations', [\App\Http\Controllers\Admin\DonationCampaignController::class, 'donations'])->name('donations');
});
// Donation Campaigns Route End
